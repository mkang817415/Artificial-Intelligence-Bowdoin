...
""" % (prereq, q, q, prereq))
      ...
      try:
        ...
        util.TimeoutFunction(getattr(gradingModule, q),3600*12)(self) # Call the question's function
    ...
    for q in self.questions:
      print ('Question %s: %3.1f/%3.1f' % (q, self.points[q], self.maxes[q]))
    print ('--------------------')
    print ('Total: %3.1f/%3.1f' % (self.points.totalCount(), sum(self.maxes.values())))
    print ("""
